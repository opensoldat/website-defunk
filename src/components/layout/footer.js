        ...
        <div className="c-footer__inner">
            ...
            <div className="c-footer__columns o-wrapper">
                ...
                <div className="c-footer__col c-footer__col--logo-sec">
                    <a href="https://store.steampowered.com/app/638490/Soldat/" className="c-footer__logo">
                        <Icon name="steam"/>
                    </a>
                </div>
                    ...
                    <nav>
                        <ul className="c-footer__list">
                            ...
                            <li className="c-footer__list-el">
                                {internal ?
                                    <Link to={path} className="c-footer__list-link">{title}</Link>
                                    :
                                    <a href={path} className="c-footer__list-link">{title}</a>
                                }
                            </li>
                            ))}
                        </ul>
                        ...
                        <ul className="c-footer__list c-footer__social-media">
                            ...
                            <li className="c-footer__social-media-el"><a href={url}
                                                                         className="c-footer__social-media-link"
                                                                         target="_blank"
                                                                         rel="noopener noreferrer" title={icon}
                                                                         aria-label={icon}>
                                <Icon name={icon}/>
                            </a></li>
                            ))}
